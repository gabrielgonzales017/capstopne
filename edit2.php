...
?></p>
  ...
  <?php
   ...
   $sql = "SELECT * FROM tblcomments WHERE id = '".$strCustomerID."' ";
...
<table  >
  <tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result["date"];?>
      <th ><b>CLIENT NUMBER</b></th>
    <td ><input type="number" class="search" name="txtid" value="<?php echo $result["number"];?>">  </td>
    </tr>
  <tr>
    <th >TEXT</th>
    <td><textarea cols="80" rows="10" name='txtplace' required="required" >Good Day this is Grand One Pavilion,</textarea> </td>
    </tr>
