  <?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		$stmt_select = $DB_con->prepare('SELECT img FROM tbl_users WHERE userID =:uid');
...
?>
  ...
  <li role="presentation" class="active"><a href="upload.php">Wedding</a></li>
  ...
  <li role="presentation"><a href="upload4.php">Others</a></li>
	...
	<div class="page-header">
    	<h1 class="h2">&nbsp; &nbsp;UPLOAD EVENTS / &nbsp; &nbsp;<a class="btn btn-default" href="addnew.php"> <span class="glyphicon glyphicon-plus"></span>  Upload </a></h1> 
    </div>
...
<?php
	...
	$stmt = $DB_con->prepare('SELECT userID, title, caption, img FROM tbl_users ORDER BY title ASC');
	$stmt->execute();
