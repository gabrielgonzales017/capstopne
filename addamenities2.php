	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute())
			{
				...
				header("refresh:5;uploada2.php"); // redirects image view page after 5 seconds.
			}
			else
			{
...
<body>
	...
	<div class="page-header">
    	<h1 class="h2">Upload Photos <a class="btn btn-default" href="uploada2.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View Photos </a></h1>
    </div>
