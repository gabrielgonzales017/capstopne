...
<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO tbl_users1(title,caption,img) VALUES(:tit, :cap, :img)');
			...
			if($stmt->execute())
			{
				...
				header("refresh:5;upload1.php"); // redirects image view page after 5 seconds.
			}
			else
			{
...
<body>
	...
	<div class="page-header">
    	<h1 class="h2">Upload Photos <a class="btn btn-default" href="upload1.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View Photos </a></h1>
    </div>
